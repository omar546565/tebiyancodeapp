      ...
      body: BlocProvider(
        ...
        child: BlocConsumer<ShopSearchCubit,ShopSearchStates>(
          ...
          builder: (context,state){
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ShopSearchCubit.get(context).srearchModel!.products!.length != null ? Center(child: Text('لايوجد منتجات في المفضلة',style: TextStyle(fontSize: 24.0,),)) : ListView.separated(
            ...
            children:[
            Text(
            '${ShopSearchCubit.get(context).srearchModel!.products![index].price.toString()}tl',
            style: TextStyle(
            fontSize: 15.0,
            fontWeight: FontWeight.bold,
            ...
            if(1 != 0)
            Text(
            '${ShopSearchCubit.get(context).srearchModel!.products![index].oldPrice.toString()}tl',
            style: TextStyle(
            fontSize: 12.0,
            fontWeight: FontWeight.bold,
            color: Colors.grey,
